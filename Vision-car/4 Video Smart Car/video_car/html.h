...
<html>
  ...
  <body>
    ...
    <hr />
      ...
      <div>
        ...
        <input
          ...
          step="1"
          value="2"
          style="width: 78%; margin-bottom: 20px; margin-top: 10px"
        />
      </div>  
       <div>
        <span>Car_Speed</span>
        <input
          ...
          step="50"
          value="50"
          style="width: 70%; margin-bottom: 20px; margin-top: 10px"
        />
      </div>       
    ...
    <script>
      ...
      document.querySelector("#Lights").addEventListener("input", (event) => {
        fetch(
